...
The primary class of interest (in our case) is \textbf{GeodesicFieldModel} -- \textbf{GFM}) for short.  We can invoke the \textbf{GFM} class as follows:
...
data: float, array
	Scalar field to which the fieldmodel will be fit.  Associates each datapoint with a numerical value.
x / y: float, array
